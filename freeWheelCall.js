          ...
          {_:{
            ...
            {adReplicaId:"0", creativeApi:"None", creativeRenditionId:"4252331", height:"1", preference:"0", width:"1", _:{
              ...
              {bytes:"6659", contentType:"text/html_lit_js_wc_nw", id:"4194863", mimeType:"text/html", name:"external url/tag for Default asset package of  - 1", _:{
                "content":[
                {
                	//_:"<span data-width=\"1\" data-height=\"1\" style=\"display:inline-block; vertical-align:top; margin:0;\"><iframe id=\"_fw_frame_kfsn_main_Overpage|Adhesion|Prestitial\" width=\"1\" height=\"1\" marginwidth=\"0\" marginheight=\"0\" frameborder=\"0\" scrolling=\"no\" ALLOWTRANSPARENCY=\"true\"><\/iframe>\n<script language=\"javascript\" type=\"text/javascript\" id=\"_fw_container_js_kfsn_main_Overpage|Adhesion|Prestitial\">//<!-- \n  (function(){\n    var fw_scope_window = window;\n    var fw_scope = document;\n    var fw_content = \"<!DOCTYPE HTML PUBLIC \\\"-//W3C//DTD HTML 4.01 Transitional//EN\\\" \\\"http://www.w3.org/TR/html4/loose.dtd\\\">\\n<html>\\n<head>\\n\\t<title>Advertisement<\/title>\\n\\t<scr\" + \"ipt type=\\\"text/javascr\" + \"ipt\\\">window._fw_page_url = \\\"http://abc30.com/\\\";<\/scr\" + \"ipt>\\n<\/head>\\n<body style=\\\"margin:0px;background-color:transparent;\\\"><iframe name=\\\"pbeacon\\\" frameborder=\\\"0\\\" allowtransparency=\\\"true\\\" hspace=\\\"0\\\" vspace=\\\"0\\\" marginheight=\\\"0\\\" marginwidth=\\\"0\\\" scrolling=\\\"no\\\"  width=\\\"0\\\"  height=\\\"0\\\" style=\\\"position:absolute;top:-20000px;\\\" src=\\\"http://ads.pubmatic.com/AdServer/js/user_sync.html?p=51217\\&s=66008\\\"> <\/iframe>\\n<scr\" + \"ipt type=\\'text/javascr\" + \"ipt\\'>\\n    (function() {\\n           \\n            function getHTML() {\\n                var ifCode = \\\"<div id=\\'pubmatic_parent\\' style=\\'position: fixed; bottom: 0px; width: 100%; z-index:1000000;\\'>\\\";\\n                ifCode += \\\" <div id=\\'pubmatic_child\\' style=\\'width: 970px; height: 90px; position: relative; margin: auto;\\'>\\\";\\n                ifCode += \\\" <\/div>\\\";\\n                ifCode += \\\"<\/div>\\\";\\n                return ifCode;\\n            }\\n\\n            if (top == self) { \\n            // do not need to escape iframe.\\n            console.log(\\'Site Structure has changed\\') \\n        }\\n            else{ \\n            // try escape iframe \\n            try{ var topIframes=top.document.getElementsByTagName(\\'IFRAME\\'); \\n            for(var i=0;i<topIframes.length;i++){ if(topIframes[i].contentWindow==self){ \\n            // found iframe that served the ad, \\n            // hide iframe that served the ad \\n            topIframes[i].height=\\'90\\'; topIframes[i].style.height=\\'90px\\'; \\n            //insert parent and child div\\n            var h=top.document.createElement(\\'span\\'); \\n            top.document.getElementsByTagName(\\'body\\')[0].appendChild(h); \\n            h.innerHTML=getHTML();       \\n            //insert pubmatic ad in iframe\\n            pubmaticadhesion=top.document.createElement(\\'IFRAME\\'); \\n            pubmaticadhesion.setAttribute(\\'id\\',\\'pm_ad\\') \\n            pubmaticadhesion.setAttribute(\\'height\\',\\'90\\') \\n            pubmaticadhesion.setAttribute(\\'width\\',\\'970\\') \\n            pubmaticadhesion.setAttribute(\\'frameborder\\',\\'0\\') \\n            pubmaticadhesion.setAttribute(\\'scrolling\\',\\'no\\') \\n            pubmaticadhesion.setAttribute(\\'marginwidth\\',\\'0\\') \\n            pubmaticadhesion.setAttribute(\\'marginheight\\',\\'0\\') \\n            pubmaticadhesion.setAttribute(\\'vspace\\',\\'0\\') \\n            pubmaticadhesion.setAttribute(\\'hspace\\',\\'0\\') \\n            pubmaticadhesion.setAttribute(\\'src\\',\\'//showads.pubmatic.com/AdServer/AdServerServlet?pubId=51217\\&siteId=66008\\&adId=1359200\\&kadwidth=970\\&kadheight=90\\&SAVersion=2\\&js=1\\&kdntuid=1\\&pageURL=abc30.com\\&kadpageurl=abc30.com\\&inIframe=1\\&operId=1\\&timezone=-4\\&screenResolution=1280x800\\&ranreq=0.31321781943552196\\&pmUniAdId=0\\&adVisibility=0\\&adPosition=-1x-1\\') \\n            pubmaticadhesion.onload = function(){\\n                pubmaticadhesion.style.display=\\'\\';\\n                console.log(\\'iframe loaded show it\\');\\n            };\\n            top.document.getElementById(\\'pubmatic_child\\').appendChild(pubmaticadhesion);  \\n\\n        } } }\\n            catch(e){ \\n            // not in friendly iframe! Bail bail bail. \\n            console.log(\\'Not in friendly iframe. Site Structure has changed\\') \\n        } \\n    }\\n})();\\n<\/scr\" + \"ipt><\/body>\\n<\/html>\";\n    var targetFrame = fw_scope.getElementById(\"_fw_frame_kfsn_main_Overpage|Adhesion|Prestitial\");\n    var targetFrameDoc = (targetFrame.contentWindow) ? targetFrame.contentWindow : (targetFrame.contentDocument.document) ? targetFrame.contentDocument.document : targetFrame.contentDocument;\n    var writeContent = function(doc, content) {\n      var timeout = 0;\n      if(navigator.userAgent.match(/MSIE/) || navigator.userAgent.match(/Opera/)){\n        timeout = 7500;\n      } else if(navigator.userAgent.match(/Gecko\\//)) {\n        timeout = 30000;\n      }\n      targetFrameDoc.document.open();\n      targetFrameDoc.document.write(fw_content);\n      if (timeout>0) { setTimeout(function(){if (!!targetFrameDoc.document) targetFrameDoc.document.close()}, timeout); }\n      else if (!timeout) { targetFrameDoc.document.close(); }\n    }\n    var hasNoSandbox = false;\n    if ('never' == \"never\"){\n    \thasNoSandbox = true;\n    }\n    else if ('never' == \"always\"){\n    \thasNoSandbox = false;\n    }\n    else{\n    \thasNoSandbox = fw_content.indexOf(\"<!-\"+\"-nosandbox-\"+\"->\") >= 0 || fw_content.indexOf(\"<!-\"+\"-noecho-\"+\"->\") >= 0 || !!'';\n    }\n    var slotContentKey = \"_fw_slot_content_kfsn_main_Overpage|Adhesion|Prestitial\";\n    var proxyHtml = window._fw_xd_proxy ? window._fw_xd_proxy : \"/_fw_xd_frame.html\";\n    if(hasNoSandbox) {\n      try {\n        if(!navigator.userAgent.match(/Gecko\\//)) { \n\t\t\t\t\twriteContent(targetFrameDoc, fw_content, 7500);\n\t\t\t\t} else if (targetFrameDoc.document.readyState == \"complete\" || targetFrameDoc.document.readyState == \"interactive\" ){\n          writeContent(targetFrameDoc, fw_content, 7500);\n        } else {\n\t\t\t\t\ttargetFrame.onload = function(){\n\t\t\t\t\t\twriteContent(targetFrameDoc, fw_content, 7500);\n\t\t\t\t\t};\n\t\t\t\t}\n      } catch (e) {\n        fw_scope_window[slotContentKey] = fw_content;\n        targetFrame.src = proxyHtml + \"?slid=kfsn_main_Overpage|Adhesion|Prestitial&domain=\" + document.domain;\n      }\n    } else {\n      fw_scope_window[slotContentKey] = fw_content;\n      try {\n        targetFrameDoc.document.write('<script> window.name = parent[\"' + slotContentKey + '\"] + \"<!--\" + Math.random() + \"-->\"; window.location.replace(\"http://m2.feiwei.tv/g/lib/template/sandbox.html\");<\\/script>');\n      } catch(e) {\n        if((/MSIE 6/i.test(navigator.userAgent) && document.domain == fw_scope_window.location.hostname) ||\n            navigator.userAgent.match(/Gecko\\//) || navigator.userAgent.match(/Safari\\//)) {\n        } else {\n          targetFrame.src = proxyHtml + \"?sandbox&slid=kfsn_main_Overpage|Adhesion|Prestitial&domain=\" + document.domain;\n        }\n      }\n    }\n  })();\n// --><\/script>\n<\/span>\n"
                	//_:"<span>Harshad Zindabad!!!</span>"
                	_:"<script type=\"text/javascript\"> alert(02051986); (function(){ var script = document.createElement('script'); script.async = true; script.type = 'text/javascript'; script.src = 'http://ads.pubmatic.com/AdServer/js/userSync.js'; script.onload = function(){ PubMaticSync.sync({ pubId: 51217 }); } var node = document.getElementsByTagName('script')[0]; node.parentNode.insertBefore(script, node); })();<\/script>"
                }]}
              }]}
            }]}
          }],
